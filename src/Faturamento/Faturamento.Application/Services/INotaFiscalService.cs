...
public interface INotaFiscalService
{
    ...
    Task<Result<RemoverNotaFiscalDto>> RemoverNotaFiscalPorIdAsync(int id, CancellationToken cancellationToken = default);
    Task<Result<AtualizarNotaFiscalDto>> AtualizarNotaFiscalPorIdAsync(int novaFiscalId, AtualizarNotaFiscalDto notaFiscal, CancellationToken cancellationToken = default);
}